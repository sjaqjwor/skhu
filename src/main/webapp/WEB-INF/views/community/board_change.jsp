         ...
         <section class="me">
            ...
            <form id="fm" method="post" enctype="multipart/form-data">
               <table class="box highlight" id="board_2">
                  ...
                  <tr>
                     <td>제목</td>
                     <td colspan="2"><input type="text" name="title" value="${board.b_title }"></td>
                  ...
                  <td class="upload">
                     ...
                     <input type="hidden" id="n_hidden" value="${board.b_id }">
                     <div id="k">
                     <div class="s">
                  ...
                  <td style="width:24%;">
                  <label><button type="button" id="board_file_delete"style="background-color: white;border: 0;">삭제</button></label>
                  </td>
                  </tr>
                  ...
                  <tr>
                     <td  colspan="4"><textarea rows="14" cols="100" name="body" class ="smarteditor2"id="body">${board.b_content}</textarea>
               ...
               <div id="pa2">
                  <ul>
                     <li><a href="board.do?${pagination.queryString}"><input type="image" src="${pageContext.request.contextPath}/resources/images/cancel.jpg" style="border-radius: 3px"></a></li>
