   ...
   <c:import url="../menu.jsp"/>
      ...
      <div class="container">
         ...
         <section class="me">
            ...
            <li style="background-color:#dcd0d0;">자유게시판</li>
                  <li id="nt" style="cursor:pointer;">공지사항</li>공지사항</li>
            </ul>
            </div>
            </div>
            </section>
            ...
            <section class="board">
               ...
               <div id="pa1">
                  ...
                  <ul>
                     <li>
                     <li><a href="board.do?${pagination.queryString}"><input type="image" src="${pageContext.request.contextPath}/resources/images/list.jpg" style="border-radius: 3px"></a></li>
                     <li><a href="board_change.do?b_id=${board.b_id }&${pagination.queryString}"><input type="image" src="${pageContext.request.contextPath}/resources/images/change.jpg" style="border-radius: 3px;display:${css};"></a></li>
                     <li><a href="board_delete.do?b_id=${board.b_id}&${pagination.queryString }"><input type="image" src="${pageContext.request.contextPath}/resources/images/delete.jpg" style="border-radius: 3px; display:${css};"></a></li>
                  </ul>
